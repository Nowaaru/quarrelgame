    ...
    return (
        ...
        >
            ...
            >
                ...
                />
                <textlabel
                    Text={ChosenCharacter.Subheader?.upper() === ChosenCharacter.Subheader
                        ? ChosenCharacter.Subheader
                        : ChosenCharacter.Subheader?.gsub("(%s%w)", (v) => v.upper())[0].gsub("^(%w)", (v) => v.upper())[0]}
                    BackgroundTransparency={1}
